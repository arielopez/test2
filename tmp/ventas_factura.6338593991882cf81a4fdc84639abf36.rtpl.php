      ...
      <div class="row" style="margin-top: 10px;">
         <div class="col-xs-8">
            ...
            <div class="btn-group">
               ...
               <a class="btn btn-sm btn-default" href="<?php echo $fsc->factura->asiento_url();?>">
      ...
      <div class="row">
         <div class="col-sm-12">
            ...
            <ol class="breadcrumb" style="margin-bottom: 5px;">
               ...
               <li><a href="<?php echo $fsc->ppage->url();?>"><?php  echo FS_FACTURAS;?></a></li>
               <li>
      ...
      <div class="tab-content">
         ...
         <?php $loop_var1=$fsc->extensions; $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>
            ...
            <div role="tabpanel" class="tab-pane" id="ext_<?php echo $value1->name;?>">
               <iframe src="index.php?page=<?php echo $value1->from;?><?php echo $value1->params;?>&id=<?php echo $fsc->factura->idfactura;?>" width="100%" height="600" frameborder="0"></iframe>
            </div>
            <?php } ?>
