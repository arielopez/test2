...
<head>
   ...
   <meta name="description" content="LimpiaMas facturacion" />
   <meta name="viewport" content="width=device-width, initial-scale=1.0" />
   <meta name="generator" content="LimpiaMas" />
...
<body>
      ...
      <div class="container-fluid">
         <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">
               ...
               <?php if( FS_DEMO ){ ?>DEMO<?php }elseif( $fsc->empresa->nombrecorto ){ ?><?php echo $fsc->empresa->nombrecorto;?><?php }else{ ?><?php echo $fsc->empresa->nombre;?><?php } ?>
         ...
         <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
               ...
               <li class="dropdown<?php if( $value1==$fsc->page->folder ){ ?> active<?php } ?>">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="text-transform: capitalize;"><?php echo $value1;?><b class="caret"></b></a>
               ...
               <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="<?php echo $fsc->user->nick;?>">
                     <span class="glyphicon glyphicon-user hidden-xs">  </span>
                      <span class="text-capitalize">&nbsp; <?php echo $fsc->user->nick;?><b class="caret"></b></span>
   ...
   <?php if( $fsc->user->css=='view/css/bootstrap.min.css' ){ ?>
