      ...
      <div class="col-sm-4 col-xs-6 text-right">
         ...
         <div class="btn-group">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
               ...
               <li>
                  <a href="<?php echo $fsc->url();?>&mostrar=<?php echo $fsc->mostrar;?>&order=vencimiento_desc">
                     <span class="glyphicon glyphicon-sort-by-attributes-alt" aria-hidden="true"></span>
                     &nbsp; Vencimiento &nbsp;
               ...
               <li>
                  <a href="<?php echo $fsc->url();?>&mostrar=<?php echo $fsc->mostrar;?>&order=vencimiento_asc">
                     <span class="glyphicon glyphicon-sort-by-attributes" aria-hidden="true"></span>
                     &nbsp; Vencimiento &nbsp;
...
<div class="table-responsive">
   <table class="table table-hover">
      ...
      <tr class="clickableRow<?php if( $value1->vencida() ){ ?> danger<?php }elseif( $value1->pagada ){ ?> success<?php }elseif( $value1->total<=0 ){ ?> warning<?php } ?>" href="<?php echo $value1->url();?>">
         <td class="text-center">
            <?php if( $value1->pagada ){ ?>

            <span class="glyphicon glyphicon-ok" title="La <?php  echo FS_FACTURA;?> está pagada"></span>
            <?php } ?>
         ...
         <td class="text-center">
            ...
            <span class="glyphicon glyphicon-paperclip" title="La <?php  echo FS_FACTURA;?> tiene vinculado un asiento contable"></span>
            <?php } ?>
         ...
         <td>
            ...
            <span class="label label-danger" title="<?php  echo FS_FACTURA_RECTIFICATIVA;?> de <?php echo $value1->codigorect;?>">
         ...
         <td>
            ...
            <a href="<?php echo $fsc->url();?>&codcliente=<?php echo $value1->codcliente;?>" class="cancel_clickable" title="Ver más <?php  echo FS_FACTURAS;?> de <?php echo $value1->nombrecliente;?>">[+]</a>
         </td>
         ...
         <td class="text-right"><?php echo $value1->vencimiento;?></td>
      </tr>
      <?php }else{ ?>
      ...
      <tr class="warning">
         <td></td>
         <td></td>
         <td colspan="6">Ninguna <?php  echo FS_FACTURA;?> encontrada. Pulsa <b>Nueva</b> para crear una.</td>
         <?php if( $fsc->codagente!=='' ){ ?>
      ...
      <div class="modal-content">
         ...
         <div class="table-responsive">
            <table class="table table-hover">
               ...
               <tr class="success">
                  <td colspan="2">No hay huecos en la numeración de <?php  echo FS_FACTURAS;?>. Eso es bueno ;-)</td>
               </tr>
               <?php } ?>
      ...
      <div class="modal-dialog" style="width: 99%; max-width: 950px;">
         <div class="modal-content">
            <div class="modal-header">
               ...
               <p class="help-block">
                  Estas buscando en las líneas de las <?php  echo FS_FACTURAS;?> de <?php echo $fsc->cliente->nombre;?>.
               </p>
               <?php }else{ ?>
