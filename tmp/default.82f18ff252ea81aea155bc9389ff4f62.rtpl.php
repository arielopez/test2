                  ...
                  <div class="container-fluid">
                     <div class="row">
                        ...
                        <div class="col-sm-7">
                           ...
                           <div class="form-group">
                              <input type="password" class="form-control input-lg pass" name="password" maxlength="12" placeholder="Contraseña"/>
                              <!--p class="help-block">
            ...
            <form name="f_new_password" action="index.php" method="post" class="form" role="form">
               ...
               <div class="modal-body">
                  ...
                  <div class="form-group">
                     ...
                     <input type="password" class="form-control" name="new_password" maxlength="12" placeholder="Nueva contraseña" required=""/>
                     <input type="password" class="form-control" name="new_password2" maxlength="12" placeholder="Repite la nueva contraseña" required=""/>
                  </div>
                  <div class="form-group">
   ...
   <div class="container-fluid" style="margin-bottom: 10px;">
      ...
      <div class="row">
         <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
            <small>
               Creado por <a target="_blank" href="">Alberto Lopez - Alder Franco</a>.
            </small>
         </div>
