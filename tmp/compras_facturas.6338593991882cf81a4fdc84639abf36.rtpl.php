   ...
   <table class="table table-hover">
      <thead>
         <tr>
            ...
            <!--th></th-->
            <th class="text-left col-md-2 col-lg-1">Código</th>
            <th class="text-left col-md-2 col-lg-1">Num. Factura</th>
      ...
      <tr class=" clickableRow<?php if( $value1->pagada ){ ?> success<?php }elseif( $value1->total<=0 ){ ?> warning<?php } ?>" href="<?php echo $value1->url();?>">
         ...
         <td>
            <a href="<?php echo $value1->url();?>"><?php echo $value1->codigo;?></a>
         ...
         <td class="text-left"><?php echo $value1->numproveedor;?></td>
         <td>
