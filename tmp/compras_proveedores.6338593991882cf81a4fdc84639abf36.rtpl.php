...
<script type="text/javascript">
   ...
   {
      alert('Los acreedores son todos aquellos proveedores a los que no les compramos mercancias. Por ejemplo: proveedor de internet, teléfono, luz, etc');
      return false;
   }
...
<ul class="nav nav-tabs">
   <li role="presentation"<?php if( $fsc->mostrar=='todo' ){ ?> class="active"<?php } ?>>
      <a class="word-upper" href="<?php echo $fsc->url();?>&mostrar=todo">
         <?php if( $fsc->query=='' ){ ?>
   ...
   <li  role="presentation"<?php if( $fsc->mostrar=='acreedores' ){ ?> class="active"<?php } ?>>
      <a href="<?php echo $fsc->url();?>&mostrar=acreedores">
         ...
         <span class="hidden-xs word-upper">&nbsp; Acreedores</span>
      </a>
   </li>
   <li >
      ...
      <thead>
         <tr class="word-upper">
            <th class="text-center col-lg-1">Código </th>
             <th class="text-left col-lg-2">Nombre</th>
            <th class="text-left col-lg-1"><?php  echo FS_CIFNIF;?></th>
            <th class="text-left col-lg-2">email</th>
            <th class="text-left col-lg-1">Teléfono</th>
         ...
         <div class="modal-content">
            <div class="modal-header">
               ...
               <p class="help-block">
                  ...
                  Por ejemplo: proveedor de internet, teléfono, luz, etc.
               </p>
            </div>
            <div class="modal-body">
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <input type="text" name="nombre" class="form-control" autocomplete="off" required="" style="text-transform: uppercase"/>
                  </div>
               </div>
               <div class="form-group">
                  <label class="col-sm-2 control-label"><?php  echo FS_CIFNIF;?></label>
                  <div class="col-sm-10">
                     <input type="text" name="cifnif" class="form-control" autocomplete="off" required="" style="text-transform: uppercase"/>
                     <label>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <select name="pais" class="form-control" style="text-transform: uppercase">
                        <?php $loop_var1=$fsc->pais->all(); $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>

                        <option style="text-transform: uppercase" value="<?php echo $value1->codpais;?>"<?php if( $value1->is_default() ){ ?>  selected=""<?php } ?>><?php echo $value1->nombre;?></option>
                        <?php } ?>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <input type="text" name="provincia" id="ac_provincia" class="form-control" autocomplete="off" style="text-transform: uppercase"/>
                  </div>
               </div>
               <div class="form-group">
                  <label class="col-sm-2 control-label">Ciudad</label>
                  <div class="col-sm-10">
                     <input type="text" name="ciudad" id="ciudad" class="form-control" style="text-transform: uppercase"/>
                  </div>
               </div>
               <!--div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <input type="text" name="direccion" class="form-control" autocomplete="off" style="text-transform: uppercase"/>
                  </div>
               </div>
            </div>
