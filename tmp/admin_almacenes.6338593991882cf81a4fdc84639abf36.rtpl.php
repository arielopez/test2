                        ...
                        <div class="col-sm-3">
                           <div class="form-group">
                              ...
                              <?php $loop_var2=$fsc->pais->all(); $counter2=-1; if($loop_var2) foreach( $loop_var2 as $key2 => $value2 ){ $counter2++; ?>
                                 ...
                                 <?php if( $value1->codpais==$value2->codpais OR $value2->codpais==$fsc->empresa->codpais ){ ?>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group">
                              ...
                              <select name="cost_is_average" class="form-control">
                                 ...
                                 <option value="0"<?php if( $GLOBALS['config2']['cost_is_average']==0 ){ ?> selected=''<?php } ?>>Editable</option>
                              </select>
                           </div>
                        </div>
                        <div class="col-sm-3">
                           <div class="form-group">
                              ...
                              <select name="precio_compra" class="form-control">
                                 <option value="coste"<?php if( $GLOBALS['config2']['precio_compra']=='coste' ){ ?> selected=''<?php } ?>>Precio de coste</option>
                                 <option value="pvp"<?php if( $GLOBALS['config2']['precio_compra']=='pvp' ){ ?> selected=''<?php } ?>>PVP</option>
                              </select>
                           </div>
                        </div>
                     </div>
