         ...
         <form name="f_empresa" action="<?php echo $fsc->page->url();?>" method="post" class="form" role="form">
            <div class="panel panel-primary" id="panel_generales">
               ...
               <div class="panel-body">
                  ...
                  <div class="form-group col-sm-3">
                     Ciudad:
                     <input class="form-control" type="text" name="ciudad" id="ciudad" value="<?php echo $fsc->empresa->ciudad;?>" autocomplete="off"/>
                  </div>
                  <div class="form-group col-sm-3">
                     Código Postal:
            ...
            <div class="panel panel-primary" id="panel_impresion">
               ...
               <div class="panel-body">
                  ...
                  <div class="form-group">
                     ...
                     <textarea name="pie_factura" rows="2" class="form-control"><?php echo $fsc->empresa->pie_factura;?></textarea>
                  </div>
                  <div class="form-group">
                     <button class="btn btn-sm btn-default" id="b_add_logo">
                        <span class="glyphicon glyphicon-picture"></span>
                        Añadir / Cambiar logotipo para los documentos
                     </button>
                  </div>
                  <div class="form-group">
                     Lema:
