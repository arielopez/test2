...
INSERT INTO `fs_access` VALUES ('Alder','admin_empresa',0),('Alder','admin_home',0),('Alder','admin_info',0),('Alder','admin_user',0),('Alder','admin_users',0),('alberto','admin_empresa',0),('alberto','admin_home',0),('alberto','admin_info',0),('alberto','admin_user',0),('alberto','admin_users',0);
...
CREATE TABLE `fs_logs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1103 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fs_vars` VALUES ('install_step','5'),('last_download_check','2016-04-23'),('mail_enc','ssl'),('mail_host','smtp.gmail.com'),('mail_port','465'),('mail_user',''),('numeracion_personalizada','1'),('print_alb','0'),('print_dto','1'),('print_ref','1'),('updates','true');
...
INSERT INTO `lineas_ordenes_compra_prov` VALUES (10000,2,0,0,NULL,'Carburante',1,7,'IVA10',NULL,10,0,10000,5000,'CARBUR-0014',NULL),(8700,3,0,0,NULL,'Bidon de 5Lts',2,8,'IVA10',NULL,10,0,8700,2900,'BIDON-5L-001',NULL);
...
INSERT INTO `lineasalbaranesprov` VALUES (10,'IVA10','Bidon de 5Lts',0,0,1,1,NULL,NULL,0,10,29000,29000,2900,0,'Bidon 5L'),(1,'IVA10','Bidon de 5Lts',0,0,2,2,NULL,NULL,0,10,2900,2900,2900,0,'BIDON-5L-001'),(5,'IVA10','Bidon de 5Lts',0,0,3,3,1,1,0,10,14500,14500,2900,0,'BIDON-5L-001'),(1,'IVA10','colorante químico',0,0,4,4,NULL,NULL,0,10,201000,201000,201000,0,'COLOR-ROJO'),(6,'IVA10','Bidon de 5Lts',0,0,5,5,2,2,0,10,17400,17400,2900,0,'BIDON-5L-001'),(4,'IVA10','Bidon de 5Lts',0,0,8,8,3,3,0,10,11600,11600,2900,0,'BIDON-5L-001');
...
INSERT INTO `orden_compra_prov` VALUES ('ORD2016A13C',11000,'4','CONT','2016',1,11000,0,7,NULL,'',NULL,1,'ALG','','1175106-1','000002',NULL,0,NULL,'CASA EDUARDO','2016-04-26','00:04:48',10000,0,'A',1000,'13','PRY'),('ORD2016A14C',9570,'4','CONT','2016',1,9570,0,8,NULL,'',NULL,1,'ALG','','1175106-1','000002',NULL,0,NULL,'CASA EDUARDO','2016-04-26','00:35:06',8700,0,'A',870,'14','PRY');
...
-- Dump completed on 2016-04-30  6:57:37
