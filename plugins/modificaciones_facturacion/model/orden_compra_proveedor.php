 ...
 * Pedido de proveedor
 */
class orden_compra_proveedor extends fs_model
{
   /**
    * Clave primaria.
    * @var type 
   ...
   public function get($id)
   {
      ...
      if($pedido)
      {
         return new orden_compra_proveedor($pedido[0]);
      }
      else
         return FALSE;
   }
   ...
   public function new_codigo()
   {
      ...
      {
         $this->codigo = strtoupper(substr('ORDEN', 0, 3)).$this->codejercicio.$this->codserie.$this->numero.'C';
//         $this->codigo = strtoupper(substr(FS_PEDIDO, 0, 3)).$this->codejercicio.$this->codserie.$this->numero.'C';
   ...
   public function all($offset = 0)
   {
      ...
      {
         foreach ($data as $p)
            $pedilist[] = new orden_compra_proveedor($p);
      }
   ...
   public function all_desde($desde, $hasta)
   {
      ...
      {
         foreach ($data as $p)
            $pedlist[] = new orden_compra_proveedor($p);
      }
