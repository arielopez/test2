...
class linea_orden_compra_proveedor extends fs_model
{
   public $cantidad;
   public $codimpuesto;
   public $descripcion;
   ...
   {
      parent::__construct('lineas_ordenes_compra_prov', 'plugins/modificaciones_facturacion/');
   ...
   public function show_codigo()
   {
      ...
      if( !$encontrado )
      {
         $pre = new orden_compra_proveedor();
   ...
   public function all_from_pedido($idp)
   {
      ...
      {
         foreach($data as $d)
            $plist[] = new linea_orden_compra_proveedor($d);
      }
   ...
   public function all_from_articulo($ref, $offset=0, $limit=FS_ITEM_LIMIT)
   {
      ...
      {
         foreach($lineas as $l)
            $linealist[] = new linea_orden_compra_proveedor($l);
      }
