...
require_once 'plugins/facturacion_base/model/terminal_caja2.php';
 ...
 * @author carlos
 */
class terminal_caja extends terminal_caja2
{
   public $nombre;
   public $comandologo;
   ...
   public function __construct($t = FALSE)
   {
      ...
      if($t)
      {
         ...
         $this->comandologo = '';
         if( isset($t['comandologo']) )
         {
            $this->comandologo = $t['comandologo'];
         }
         
         $this->cambiar_agente = $this->str2bool($t['cambiar_agente']);
         $this->forzar_pin = $this->str2bool($t['forzar_pin']);
      }
      else
      {
         $this->nombre = NULL;
