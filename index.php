...
else
{
   ...
   if($fsc->template)
   {
      ...
      {
         echo '<center>'
         . '<h1>No se puede escribir sobre la carpeta tmp de </h1>'
         . '<p>Consulta la <a target="_blank" href="//">documentaci&oacute;n</a>.</p>'
         . '</center>';
         die('<center><iframe src="" width="90%" height="800"></iframe></center>');
      }
